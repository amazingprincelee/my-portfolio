...
export const greetings: GreetingsType = {
  ...
  description:
    "I'm a professional Full-Stack Web Developer with six years of experience. My skills encompass javaScript, React.js, Next.js, SQL, MongoDB Nodejs for web development, and Solidity, Web3.js, Ether.js, and Hardhat for Ethereum blockchain development.",
  resumeLink:
