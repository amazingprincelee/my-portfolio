...
export const greetings: GreetingsType = {
  ...
  description:
    "Im a professional full stack web developer with 6 years of experience in web applications. My expertise lies in using python Django, React.js, Next.js for Web development and Solidity, Web3.js, either.js, hardhart for Blockchain development on etherum.",
  resumeLink:
